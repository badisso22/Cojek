...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_array($messages) || count($messages) === 0) {
        echo json_encode(['success' => false, 'error' => 'Message array required']);
        exit;
    }
    $prompt = "You are an AI project tutor. The user's project is: '$project_title'. Description: $project_desc. Help with any questions, advice, or clarifications.\n";
